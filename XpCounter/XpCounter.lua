...
function XpCounter_UpdateOverlay()
	...
	if (string.find(msg, "#xp_act#")) then
		msg = string.gsub(msg, "#xp_act#", tostring(XpCounter_xp))
	end
	if (string.find(msg, "#xp_max#")) then
		msg = string.gsub(msg, "#xp_max#", tostring(XpCounter_xp_max))
	end	
	if (string.find(msg, "#xp_perc#")) then
		msg = string.gsub(msg, "#xp_perc#", tostring(XpCounter_xp_percent))
	end	
	if (string.find(msg, "#xp_left#")) then
		msg = string.gsub(msg, "#xp_left#", tostring(XpCounter_xp_left))
	end			
	if (string.find(msg, "#xp_rested#")) then
		msg = string.gsub(msg, "#xp_rested#", tostring(XpCounter_xp_rest))
	end
	if (string.find(msg, "#xp#")) then
		msg = string.gsub(msg, "#xp#", tostring(XpCounter_Config["xp_count"]))
	end
	if (string.find(msg, "#time_played#")) then
		msg = string.gsub(msg, "#time_played#", tostring(XpCounter_time_hours.."h"..tostring(XpCounter_time_minutes.."m")))
	end
	if (string.find(msg, "#time_left#")) then
		msg = string.gsub(msg, "#time_left#", tostring(XpCounter_time_lvlup_hours.."h"..tostring(XpCounter_time_lvlup_minutes.."m")))	
	end
	if (string.find(msg, "#eph#")) then
		msg = string.gsub(msg, "#eph#", tostring(XpCounter_xp_eph))
	end
	if (string.find(msg, "#epm#")) then
		msg = string.gsub(msg, "#epm#", tostring(XpCounter_xp_epm))
	end
	if (string.find(msg, "#kills#")) then
		msg = string.gsub(msg, "#kills#", tostring(XpCounter_Config["kills"]))
	end
	if (string.find(msg, "#avg_kill_xp#")) then
		msg = string.gsub(msg, "#avg_kill_xp#", tostring(XpCounter_Config["avg_kill_xp"]))
	end
	if (string.find(msg, "#kills_left#")) then
		msg = string.gsub(msg, "#kills_left#", tostring(XpCounter_kills_left))
	end
